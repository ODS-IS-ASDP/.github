<img src="https://github.com/ODS-IS-ASDP/.github/blob/main/images/ODS_Logo.png" width="60%">

## Open Data Spaces 車載半導体データプラットフォーム 関連リポジトリ
...
「Automotive Semiconductor Data Platform（ASDP）（車載半導体データプラットフォーム）」インダストリサービスでは、車載半導体データプラットフォームにおけるデータ連携基盤を実装するための各種ライブラリやツール類を共創しています。

インダストリサービスの関連リポジトリは、[こちら](https://github.com/orgs/ODS-IS-ASDP/repositories)から。
